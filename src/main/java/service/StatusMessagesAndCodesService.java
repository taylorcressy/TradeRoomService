...
public class StatusMessagesAndCodesService {
	...
	public static int RESPONSE_FRIEND_REQ_SUCCESS = 175;
	public static int RESPONSE_FRIEND_REQ_FAIL_NONE = 176;
	public static int RESPONSE_FRIEND_REQ_FAIL_DUPLICATE = 177;
	public static int RESPONSE_FRIEND_REQ_FAIL_INVALID = 178;
